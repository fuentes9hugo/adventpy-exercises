...
cada dígito está compuesto por 7 filas y 3 columnas. Los píxeles en rojo, nosotros lo representaremos con un asterisco (*), y los píxeles en blanco, con un espacio ()."""


def drawClock(time: str) -> list[list[str]]:
    clock_chars = {
        "0": [["*", "*", "*"], ["*", " ", "*"], ["*", " ", "*"], ["*", " ", "*"], ["*", " ", "*"], ["*", " ", "*"], ["*", "*", "*"]],
        "1": [[" ", " ", "*"], [" ", " ", "*"], [" ", " ", "*"], [" ", " ", "*"], [" ", " ", "*"], [" ", " ", "*"], [" ", " ", "*"]],
        "2": [["*", "*", "*"], [" ", " ", "*"], [" ", " ", "*"], ["*", "*", "*"], ["*", " ", " "], ["*", " ", " "], ["*", "*", "*"]],
