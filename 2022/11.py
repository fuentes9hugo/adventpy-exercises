...
def getCompleted(part: str, total: str) -> str:
    part, total = tuple(map(lambda x: int(x), part.split(":"))), tuple(map(lambda x: int(x), total.split(":")))
    
    seconds_conversion = (3600, 60, 1)
...
def main():
    print(test("1/3", getCompleted('01:00:00', '03:00:00'))) # '1/3'
    print(test("1/2", getCompleted('02:00:00', '04:00:00'))) # '1/2'
    print(test("1/1", getCompleted('01:00:00', '01:00:00'))) # '1/1'
    print(test("1/6", getCompleted('00:10:00', '01:00:00'))) # '1/6'
    print(test("1/3", getCompleted('01:10:10', '03:30:30'))) # '1/3'
    print(test("3/5", getCompleted('03:30:30', '05:50:50'))) # '3/5
