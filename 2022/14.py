...
def main():
    print(test(2, getOptimalPath([[0], [2, 3]]))) # 2
    # 0 -> 2

    print(test(5, getOptimalPath([[0], [3, 4], [9, 8, 1]]))) # 5
    # 0 -> 4 -> 1

    print(test(8, getOptimalPath([[1], [1, 5], [7, 5, 8], [9, 4, 1, 3]]))) # 8
    # 1 -> 1 -> 5 -> 1
    ...
    print(test(23, getOptimalPath(pyramid)))
    ...
    print(test(8, getOptimalPath(pyramid_2)))
    ...
    print(test(-5, getOptimalPath(pyramid_3)))
    ...
    print(test(-948, getOptimalPath(pyramid_4)))

    pyramid_5 = [[1], [1, 1], [1, 1, 1]]

    print(test(3, getOptimalPath(pyramid_5)))

    print(test(10, getOptimalPath([[10]])))
